...
const approvalHistorySchema = new mongoose.Schema(
  {
    ...
    correctionRequestId: { type: mongoose.Schema.Types.ObjectId, ref: "CorrectionRequest", index: true },
    leaveRequestId: { type: mongoose.Schema.Types.ObjectId, ref: "LeaveRequest", index: true },
    action: { type: String, required: true, enum: ["Submitted", "Approved", "Rejected", "Cancelled"] },
