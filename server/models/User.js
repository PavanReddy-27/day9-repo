...
exports.EmployeeAuth = exports.ManagerAuth = exports.HRAuth = exports.AdminAuth = exports.User = void 0;
...
userSchema.methods.matchPassword = function (enteredPassword) {
    return __awaiter(this, void 0, void 0, function () {
        var isArgonMatch, isBcryptMatch, rolePrefix;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(this.password && this.password.startsWith('$argon2'))) return [3 /*break*/, 2];
                    return [4 /*yield*/, argon2.verify(this.password, enteredPassword)];
                case 1:
                    isArgonMatch = _a.sent();
                    if (isArgonMatch)
                        return [2 /*return*/, true];
                    _a.label = 2;
                case 2: return [4 /*yield*/, bcryptjs_1.default.compare(enteredPassword, this.password)];
                case 3:
