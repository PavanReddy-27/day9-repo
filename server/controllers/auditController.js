 ...
 */
var getAuditLogs = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, page, _c, limit, search, query, rx, skip, _d, logs, total, error_1;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                _e.trys.push([0, 2, , 3]);
                _a = req.query, _b = _a.page, page = _b === void 0 ? 1 : _b, _c = _a.limit, limit = _c === void 0 ? 50 : _c, search = _a.search;
                query = { companyId: req.companyId };
                if (search) {
                    rx = new RegExp(String(search).trim(), "i");
                ...
                return [4 /*yield*/, Promise.all([
                        AuditLog_js_1.default.find(query).sort({ timestamp: -1 }).skip(skip).limit(parseInt(String(limit))).lean(),
